...
func (t *InspectContainerTask) Validate() bool {
	if "" == t.container {
...
func CreateInspectContainerCommand(container string) (*InspectContainerTask, error) {
	command := &InspectContainerTask{container: container}
	if !command.Validate() {
